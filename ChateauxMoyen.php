...
$sql = "SELECT * FROM Chateaux,Categories WHERE (Chateaux.idCategorie = 4)  AND Chateaux.idCategorie = Categories.idCategorie AND Chateaux.Localisation = 'SOUTH' ORDER BY Chateaux.idCategorie DESC";
