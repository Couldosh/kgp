...
$sql = "SELECT * FROM Chateaux,Categories WHERE (Chateaux.idCategorie = 1)  AND Chateaux.idCategorie = Categories.idCategorie AND Chateaux.Localisation = 'NORTH' ORDER BY Chateaux.idCategorie DESC";
