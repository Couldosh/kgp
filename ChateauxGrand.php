...
$sql = "SELECT * FROM Chateaux,Categories WHERE (Chateaux.idCategorie = 5 OR Chateaux.idCategorie = 6 OR Chateaux.idCategorie=7) AND Chateaux.idCategorie = Categories.idCategorie AND Chateaux.Localisation = 'NORTH' ORDER BY (Chateaux.idCategorie) DESC ";
