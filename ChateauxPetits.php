...
$sql = "SELECT * FROM Chateaux,Categories WHERE (Chateaux.idCategorie = 2 OR Chateaux.idCategorie = 3)  AND Chateaux.idCategorie = Categories.idCategorie AND Chateaux.Localisation = 'NORTH' ORDER BY Chateaux.idCategorie DESC";
